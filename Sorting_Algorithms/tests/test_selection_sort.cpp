...
TEST_F(SelectionSortTest, SortsVectorCorrectlyWith__SpecificSeed)
{
...
TEST_F(SelectionSortTest, SortsVectorCorrectlyWith__DescendingOrderVector)
{
...
TEST_F(SelectionSortTest, Handles__EmptyVector)
{
...
TEST_F(SelectionSortTest, Handles__AlreadySortedVector)
{
